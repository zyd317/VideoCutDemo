...
const clearTopLogo = `ffmpeg -i ${filePath} -b:v 548k -vf delogo=x=20:y=7:w=132:h=152 ${filePath2}`;
const clearBottomLogo = ` ffmpeg -i ${filePath} -b:v 548k -vf delogo=x=22:y=563:w=132:h=142 ${filePath2}`;
